"""Nottingham MEGUK: Fix structural MRI files.

The sform header in the publicly available MEGUK data is incompatible with
RHINO, we create a copy and fix the MRI files in this script.
"""
...
smri_template = "data/raw/Nottingham/{0}/anat/{0}_T1w.nii.gz"
...
for path in sorted(glob(preproc_dir + "/*/sub-*_preproc-raw.fif")):
    ...
    smri_file = smri_template.format(subject)
