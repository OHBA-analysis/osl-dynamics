...
# ********************************
# When we see differences in groups, we should perform a statistical significance test to rule out the possibility that we're observing the effect purely by chance. We can use the osl-function `analysis.statistics.group_diff_max_stat_perm <https://osl-dynamics.readthedocs.io/en/latest/autoapi/osl_dynamics/analysis/statistics/index.html#osl_dynamics.analysis.statistics.group_diff_max_stat_perm>`_ to do this.
...
#%%
# We see group 1 has significantly less power in posterior temporal lobe compared to group 2.
#
