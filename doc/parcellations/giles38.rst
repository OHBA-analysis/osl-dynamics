...
+-------+------------------------------------------------------+------------+-------+--------+-------+
| 4     | Inferior Frontal Cortex (ventrolateral)              | left       | -53.0 | -9.8   | 29.4  |
+-------+------------------------------------------------------+------------+-------+--------+-------+
| 5     | Inferior Frontal Cortex (ventrolateral)              | right      | 53.7  | -9.8   | 29.4  |
+-------+------------------------------------------------------+------------+-------+--------+-------+
...
+-------+------------------------------------------------------+------------+-------+--------+-------+
| 14    | Intraparietal / Temporal-Parieto-Occipital junction  | left       | -36.4 | -74.5  | 37.4  |
+-------+------------------------------------------------------+------------+-------+--------+-------+
| 15    | Intraparietal / Temporal-Parieto-Occipital junction  | right      | 36.5  | -74.2  | 37.6  |
+-------+------------------------------------------------------+------------+-------+--------+-------+
...
+-------+------------------------------------------------------+------------+-------+--------+-------+
| 22    | Inferior Frontal / Ventrolateral PFC                 | left       | -42.4 | 29.5   | 11.9  |
+-------+------------------------------------------------------+------------+-------+--------+-------+
| 23    | Inferior Frontal / Ventrolateral PFC                 | right      | 42.8  | 29.9   | 12.0  |
+-------+------------------------------------------------------+------------+-------+--------+-------+
...
+-------+------------------------------------------------------+------------+-------+--------+-------+
| 26    | Superior Frontal / Dorsomedial PFC                   | left       | -22.9 | 10.0   | 56.1  |
+-------+------------------------------------------------------+------------+-------+--------+-------+
| 27    | Superior Frontal / Dorsomedial PFC                   | right      | 23.0  | 10.0   | 56.1  |
+-------+------------------------------------------------------+------------+-------+--------+-------+
| 28    | Superior Dorsolateral Prefrontal Cortex              | left       | -14.7 | 36.9   | 46.9  |
+-------+------------------------------------------------------+------------+-------+--------+-------+
| 29    | Superior Dorsolateral Prefrontal Cortex              | right      | 14.6  | 37.4   | 46.7  |
+-------+------------------------------------------------------+------------+-------+--------+-------+
...
+-------+------------------------------------------------------+------------+-------+--------+-------+
| 36    | Posterior Cingulate / Midline Precuneus              | midline    | 0.5   | -60.4  | 33.8  |
+-------+------------------------------------------------------+------------+-------+--------+-------+
| 37    | Anterior Cingulate / Medial Prefrontal (midline)     | midline    | 0.1   | 44.7   | 10.5  |
+-------+------------------------------------------------------+------------+-------+--------+-------+
