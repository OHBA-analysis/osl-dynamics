...
+--------------------------------------------------------------------------+
| :doc:`atlas-Schaefer_nparc-100_space-MNI_res-8x8x8.nii.gz <schaefer100>` |
+--------------------------------------------------------------------------+
| :doc:`atlas-Schaefer_nparc-100_space-MNI_res-5x5x5.nii.gz <schaefer100>` |
+--------------------------------------------------------------------------+
...
+----------------------------------------------------------------+
| :doc:`atlas-AAL_nparc-116_space-MNI_res-8x8x8.nii.gz <aal116>` |
+----------------------------------------------------------------+
| :doc:`atlas-AAL_nparc-78_space-MNI_res-8x8x8.nii.gz <aal78>`   |
+----------------------------------------------------------------+
| :doc:`atlas-AAL_nparc-24_space-MNI_res-8x8x8.nii.gz <aal24>`   |
+----------------------------------------------------------------+
