...
from osl_dynamics.models import dynemo_obs, directional_sedynemo_obs
...
class Model(VariationalInferenceModelBase):
    ...
    def get_group_means_covariances(self):
        ...
        """
        return directional_sedynemo_obs.get_group_means_covariances(self.model)
    ...
    def get_subject_embeddings(self):
        ...
        """
        return directional_sedynemo_obs.get_subject_embeddings(self.model)
    ...
    def get_subject_means_covariances(self):
        ...
        """
        return directional_sedynemo_obs.get_subject_means_covariances(
    ...
    def set_bayesian_kl_scaling(self, training_dataset):
        ...
        directional_sedynemo_obs.set_bayesian_kl_scaling(
