...
if __name__ == '__main__':
    ...
    save_dir = f'./results_simulation_202311_toy_6_lr_0.001/{model}_ICA_{n_channels}_state_{n_states}/'
    ...
    if model == 'SWC':
        old_dir = f'./results_simulation_202311_toy_6/{model}_ICA_{n_channels}/'
